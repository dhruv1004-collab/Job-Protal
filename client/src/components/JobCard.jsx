  ...
  return (
    <div className='border p-6 shadow rounded '>
      <div className='flex justify-between flex-col'>
        <img className='h-8 w-9' src={assets.company_icon} alt="" />
        ...
        <div className='mt-4 flex gap-4 text-sm'>
            ...
            <button onClick={()=>{navigate(`/apply-job/${job._id}`); scrollTo(0,0)}} className='text-gray-500 border border-gray-500 rounded px-2 py-2 cursor-pointer'>Learn more</button>
        </div>
      </div>
    </div>
  )
